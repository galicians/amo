...
var precacheConfig = [];
var cacheName = 'sw-precache-v2-webpack-site-cache-' + (self.registration ? self.registration.scope : '');
...
toolbox.router.get(/^https:\/\/maxcdn\.bootstrapcdn\.com\/bootstrap\/3\.3\.7\/css\/bootstrap\.min\.css/, toolbox.cacheFirst, {});
toolbox.router.get(/^http:\/\/fonts\.googleapis\.com\/css\?family=Roboto/, toolbox.cacheFirst, {});
toolbox.router.get(/^https:\/\/fonts\.googleapis\.com\/icon\?family=Material\+Icons/, toolbox.cacheFirst, {});
toolbox.router.get(/^https:\/\/1stcreditv5-dev\.telrock\.com\/telrock-tas-war\/rest\/properties/, toolbox.cacheFirst, {});
toolbox.router.get(/^https:\/\/1stcreditv5-dev\.telrock\.com\/telrock-tas-war\/rest\/idv\/process/, toolbox.cacheFirst, {});
