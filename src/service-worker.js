...
// var MAIN_CACHE_NAME = 'main-cache-v1'; 
// var main_cache_items = [
...
// 	console.log('HIT ME');
// 	event.waitUntil(
// 		caches.open( MAIN_CACHE_NAME ).then(function( cache ) {
// 			console.log('[Service Worker] Caching AppShell');
// 			return cache.addAll( main_cache_items );
// 		})
// 	);
// });

// cache front components  html, css, js
//  main shell
// 	app/idv
// 	app/welcome
// 	portal/auth
...
toolbox.router.get(/^https:\/\/localhost:8443\/rest\/properties/, toolbox.fastest, {});
toolbox.router.get(/^https:\/\/localhost:8443\/rest\/idv\/process/, toolbox.fastest, {});
